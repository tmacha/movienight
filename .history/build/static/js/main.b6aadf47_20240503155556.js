/*! For license information please see main.b6aadf47.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, n, t) => {
  ...
  (t.m = e),
    ...
    (t.u = (e) => "static/js/" + e + ".27f3c707.chunk.js"),
    (t.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var n = (n, r) => {
        ...
        r = (self.webpackChunkmovienight = self.webpackChunkmovienight || []);
            ...
            children: [
              (0, r.jsxs)("form", {
                onSubmit: async (e) => {
                  e.preventDefault();
                  try {
                    const e = await fetch("/movies/search?q=".concat(n));
              ...
              o
                ? (0, r.jsx)("p", { style: { color: "red" }, children: o })
                : (0, r.jsx)("div", {
                    className: "movie-grid",
                    children: l.map((e, n) => {
                      const t = e.BoxOffice
                        ? parseFloat(e.BoxOffice.replace(/[\$,]/g, ""))
                        : 0;
                      let l;
                      l =
                        t >= 1e6
...
//# sourceMappingURL=main.b6aadf47.js.map
